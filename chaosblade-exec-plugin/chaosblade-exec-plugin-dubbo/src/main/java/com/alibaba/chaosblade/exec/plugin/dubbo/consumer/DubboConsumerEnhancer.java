...
public class DubboConsumerEnhancer extends DubboEnhancer {
    ...
    public EnhancerModel addModelMatchers(ClassLoader classLoader, String className, Object object, Method method, Object[] methodArguments, EnhancerModel model, String targetName) {
        try {
            ...
            Map<String, Map<String, String>> businessParams = getBusinessParams(invocation, targetName);
    ...
    protected Map<String, Map<String, String>> getBusinessParams(final Object invocation, String targetName) throws Exception {
