...
import com.otel.business.c.exec.plugin.http.enhancer.InternalEnhancerContainer;
...
public class AsyncHttpClientEnhancerWrapper extends BeforeEnhancer {
  private static final Logger LOGGER =
      LoggerFactory.getLogger(AsyncHttpClientEnhancerWrapper.class);
  ...
  public EnhancerModel doBeforeAdvice(
    ...
    if (enhancer != null) {
      if (enhancer instanceof BeforeEnhancer) {
        ...
        return beforeEnhancer.doBeforeAdvice(
