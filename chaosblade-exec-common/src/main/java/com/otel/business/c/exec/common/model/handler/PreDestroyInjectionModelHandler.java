package com.otel.business.c.exec.common.model.handler;
 ...
 *
 * <p>Useful for need do something on model level not action level when receive a destroy request
 *
 * <p>For example,a module contains multiple actions, before invoke destroy actions,we need do
 * something,so you can make
 *
 * @author RinaisSuper @{@link com.otel.business.c.exec.common.model.ModelSpec} implements this
 *     interface.
 * @date 2019-04-19
 */
